...
namespace Y5Lib
{
    public unsafe static class Screen
    {
        ...
        public static Vector3 WorldToScreenRatio(Vector3 world)
        {
            ...
            return new Vector3(ratio.x, ratio.y, ratio.z);
        }

        public static Vector2 ScreenRatioToPixels(Vector3 screenRatio)
        {
            Vector4 pixels;
            Vector4 ratio = new Vector4(screenRatio.x, screenRatio.y, screenRatio.z, 0);
