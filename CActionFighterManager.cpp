...
CActionFighterManager::_GetFighterByUID CActionFighterManager::ASM_GetFighterByUID = (CActionFighterManager::_GetFighterByUID)(Memory::ReadCall2(PatternScan("E8 ? ? ? ? 48 85 C0 0F 84 ? ? ? ? F7 80 ? ? ? ? ? ? ? ? 0F 84")));